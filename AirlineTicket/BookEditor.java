...
public class BookEditor{
    public static void main(String[] args) {
        /*
         2)When enter the Book Flightwithbookid,flightid,class,date of jounrey,date of booking,number of adults,number of hilds,gender,ticketfare and customer id details to input and print with setter and getter methods?
         */
